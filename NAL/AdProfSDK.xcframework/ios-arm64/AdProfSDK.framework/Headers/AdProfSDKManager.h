...
typedef void (^AdProfInitResultBlock)(BOOL isSucc, NSError * _Nullable error);
 ...
 * @param resultBlock - AdProf SDK初始化结果
 */
+ (NSError *)initWithClientId:(NSString *)clientId andClientSecret:(NSString *)clientSecret andInitResult:(AdProfInitResultBlock)resultBlock;
