...
#import <MPAdSDK/MPNativeAdData.h>
#import <MPAdSDK/MPNativeAdRelatedView.h>


NS_ASSUME_NONNULL_BEGIN

@interface MPNativeAdObject : NSObject

/// 广告数据
@property (nonatomic, strong, readonly) MPNativeAdData *adData;
/// 视频relatedView
@property (nonatomic, strong, readonly)MPNativeAdRelatedView *relatedView;
