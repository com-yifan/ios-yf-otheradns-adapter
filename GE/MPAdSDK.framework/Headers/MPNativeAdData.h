...
@interface MPMediaInfo: NSObject
/// 素材宽
...
/// 素材地址
@property (nonatomic, strong, readonly) NSArray <MPMediaInfo *> *imageUrls;
/// 视频类素材描述
@property (nonatomic, strong, readonly) MPMediaInfo *videoAdInfo;
